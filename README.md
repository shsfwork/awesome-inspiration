...
- [Flownato](https://www.flownato.com/) - Real Android app screens, complete user flows and UI patterns from Indian consumer apps, with public previews and an MCP server for design research.
